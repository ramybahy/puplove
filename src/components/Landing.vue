    ...
    <div class="landing-page">
        <div class="on-mobile">
            ...
            <div class="mobile-table">
                ...
                <img class="no-mobile" src="./../../public/icons/sad_puplove.png">
            </div>
        </div>
        <div class="header-landing">
            <img class="puplove-logo" src="./../../public/icons/logo.png">
        ...
        <div class="upper-container">
            <div class="info-pages">
                ...
                >
                    <div class="intro-top">
                        <h1>Welcome to Puplove!</h1>
                        <img class="my-logo" src="./../../public/icons/logo.png">
                        <h3><i>Anything is pawssible</i></h3>
                        <br>
                        <p>Puplove is the best place on the internet to meet amazing pups and their owners!</p>
